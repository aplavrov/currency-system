...
const file_exchange_exchange_proto_rawDesc = "" +
	"\n" +
	"\x17exchange/exchange.proto\x12;github.com.aplavrov.currency_system.proto_exchange.exchange\"W\n" +
	...
	"\vto_currency\x18\x02 \x01(\tR\n" +
	"toCurrency\x12\x12\n" +
	"\x04rate\x18\x03 \x01(\x02R\x04rate\"\xc6\x01\n" +
	"\x15ExchangeRatesResponse\x12s\n" +
	"\x05rates\x18\x01 \x03(\v2].github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRatesResponse.RatesEntryR\x05rates\x1a8\n" +
	"\n" +
	"RatesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x02R\x05value:\x028\x01\"\a\n" +
	"\x05Empty2\xfe\x02\n" +
	"\x0fExchangeService\x12\xaa\x01\n" +
	"\x10GetExchangeRates\x12B.github.com.aplavrov.currency_system.proto_exchange.exchange.Empty\x1aR.github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRatesResponse\x12\xbd\x01\n" +
	"\x1aGetExchangeRateForCurrency\x12L.github.com.aplavrov.currency_system.proto_exchange.exchange.CurrencyRequest\x1aQ.github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRateResponseBBZ@github.com/aplavrov/currency-system/proto-exchange/exchange_grpcb\x06proto3"
...
var file_exchange_exchange_proto_goTypes = []any{
	(*CurrencyRequest)(nil),       // 0: github.com.aplavrov.currency_system.proto_exchange.exchange.CurrencyRequest
	(*ExchangeRateResponse)(nil),  // 1: github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRateResponse
	(*ExchangeRatesResponse)(nil), // 2: github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRatesResponse
	(*Empty)(nil),                 // 3: github.com.aplavrov.currency_system.proto_exchange.exchange.Empty
	nil,                           // 4: github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRatesResponse.RatesEntry
}
var file_exchange_exchange_proto_depIdxs = []int32{
	4, // 0: github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRatesResponse.rates:type_name -> github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRatesResponse.RatesEntry
	3, // 1: github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeService.GetExchangeRates:input_type -> github.com.aplavrov.currency_system.proto_exchange.exchange.Empty
	0, // 2: github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeService.GetExchangeRateForCurrency:input_type -> github.com.aplavrov.currency_system.proto_exchange.exchange.CurrencyRequest
	2, // 3: github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeService.GetExchangeRates:output_type -> github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRatesResponse
	1, // 4: github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeService.GetExchangeRateForCurrency:output_type -> github.com.aplavrov.currency_system.proto_exchange.exchange.ExchangeRateResponse
